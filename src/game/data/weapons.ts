...
export const WEAPON_DATA: Record<WeaponId, WeaponData> = {
  ...
  [WeaponId.PLAGUE_SPREADER_GUN]: {
    ...
    spread: 0.08,
    pelletCount: 1,
    projectileType: ProjectileTypeId.PLAGUE_SPREADER,
    moveSpeedMultiplier: 0.9,
    automatic: true,
    unlockXp: 12500,
  },

  [WeaponId.RAINBOW_GUN_WEAPON]: {
    name: 'Rainbow Gun',
    damage: 40,
    fireRate: 0.2,
    clipSize: 25,
    ...
    spread: 0.04,
    pelletCount: 1,
    projectileType: ProjectileTypeId.RAINBOW_GUN,
    moveSpeedMultiplier: 0.95,
    automatic: true,
    unlockXp: 13000,
  },
  ...
  [WeaponId.GRIM_WEAPON]: {
    ...
    spread: 0.03,
    pelletCount: 1,
    projectileType: ProjectileTypeId.GRIM_WEAPON,
    moveSpeedMultiplier: 0.9,
    automatic: true,
    unlockXp: 14000,
  },
  ...
  [WeaponId.BUBBLEGUN]: {
    ...
    spread: 0.1,
    pelletCount: 1,
    projectileType: ProjectileTypeId.BUBBLEGUN,
    moveSpeedMultiplier: 1.0,
    automatic: true,
    unlockXp: 11000,
  },
  ...
  [WeaponId.SPIDER_PLASMA]: {
    ...
    spread: 0.05,
    pelletCount: 1,
    projectileType: ProjectileTypeId.SPIDER_PLASMA,
    moveSpeedMultiplier: 0.95,
    automatic: true,
    unlockXp: 13500,
  },
  ...
  [WeaponId.TRANSMUTATOR]: {
    ...
    spread: 0.06,
    pelletCount: 1,
    projectileType: ProjectileTypeId.TRANSMUTATOR,
    moveSpeedMultiplier: 0.9,
    automatic: true,
    unlockXp: 14500,
  },
  ...
  [WeaponId.BLASTER_R_300]: {
    ...
    spread: 0.04,
    pelletCount: 1,
    projectileType: ProjectileTypeId.BLASTER_R_300,
    moveSpeedMultiplier: 0.95,
    automatic: true,
    unlockXp: 15000,
  },
  ...
  [WeaponId.NUKE_LAUNCHER]: {
    ...
    spread: 0.15,
    pelletCount: 1,
    projectileType: ProjectileTypeId.NUKE_LAUNCHER,
    moveSpeedMultiplier: 0.7,
    automatic: false,
    unlockXp: 20000,
  },

  [WeaponId.LIGHTING_RIFLE]: {
    ...
    spread: 0.02,
    pelletCount: 1,
    projectileType: ProjectileTypeId.LIGHTING_RIFLE,
    moveSpeedMultiplier: 0.9,
    automatic: false,
    unlockXp: 16000,
  },
